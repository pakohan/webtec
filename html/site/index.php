					...
					<div class="span9">
						<section id="welcome">
							<div id="welcome2">
								...
								<div>
									<p>
										<img src="../img/screenshots/SeaPal-Horiz2.jpg" alt="" height="200" width="620">
									</p>
									<p>
						...
						<section id="overview">
							<div id="overview2">
								...
								<div>
									<p>
										<img src="../img/screenshots/SeaPal-Horiz3.jpg" alt="" height="200" width="620">
									</p>
									<p>
									...
									<ul>
										...
										<li>Position from GPS always visible in the map view
										</li>
										<li>Course and speed always visible in the map view
										</li>
										<li>Free navigation on the map with swipe and pinch
										</li>
										<li>Fast return to the current position
										</li>
										<li>Route planing, waypoints are editable
										</li>
										<li>Automatic waypoint switching
										</li>
										<li>Bearing and distance to any particular point with long-touch
										</li>
										<li>Placing of permanent marks on the map
										</li>
										<li>Add marks using bearing or coordinates
										</li>
										<li>Select any mark as target
										</li>
										<li>Bearing and distance to current target always visible in the map view
										</li>
										<li>Distance measurement, even across several waypoints
										</li>
										<li>&amp;quotPerson over Board" functionality
										</li>
									</ul><br>
									<br>
								</div>
						...
						<div id="extension">
							...
							<ul>
								<li>Logbook function for one or several boats
								</li>
								<li>Automatic tracking
								</li>
								<li>Automatic or manual logbook entries
								</li>
								<li>Fotos for logbook entries
								</li>
								<li>Collection of regional Points of Interest
								</li>
							</ul>
						</div><br>
						<br>
