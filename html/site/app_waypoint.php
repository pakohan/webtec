...
<html lang="de">
    ...
    <body>
      ...
      <div>
        ...
        ?>
        <form method="post" action="./app_waypoint.php">
          <fieldset>
            <div>
                <br>
                <h2>
...
=======
                ...
                <div>
                  ...
                  <input type="number" name="wind_direction" pattern="\d[\d][\d]" min="0" max="359" value="0"/>
                </div>
                <div>
                  <label>Air pressure (mBar)</label>
                  <input type="number" name="air_pressure" pattern="\d\d\d[\d]" min="500" max="2000" value="1000"/>
                </div>
                <div>
                  ...
                  <select name="cloudiness">
                    ...
                    <option value="7">7</option>
                    <!--option value="8">8</option>
>>>>>>> made it possible to input data into the weather form
                      <option value="9">9</option>
                      <option value="10">10</option>
                      <option value="11">11</option>
                      <option value="12">12</option-->
            ...
            <div>
                ...
                <div>
                  ...
                  <input type="text" name="wave_height"/>
                </div>
                <div>
                  <label>wave direction</label>
                  <input type="number" name="wave_direction" pattern="\d[\d][\d]" min="0" max="359" value="0"/>
                </div>
                <div>
                  <label>date of recognition</label>
                  <input type="datetime" name="date_measured"/>
                </div>
            </div>
        </div><!-- Content -->
        <!-- Container -->
