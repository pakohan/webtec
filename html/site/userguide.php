				...
				<div>
					...
					<div>
						<div>
							<ul>
								<li>
									<a href="#">Installing SeaPal</a>
								</li>
								<li>
									<a href="#">Starting SeaPal</a>
								</li>
								<li>
									<a href="#">Map Selection</a>
								</li>
								<li>
									<a href="../img/screenshots/SeaPal-Legend-IBN-Map.pdf">Legend of IBN Maps</a>
								</li>
							</ul>
						</div>
					</div><!-- Sidebar -->
